...
public class Logicos {
    ...
    public static void main(String[] args) {
        ...
        boolean xor = (a == 3) ^ (b == 5);
        System.out.println(
                "Operador de XOR ou or exclusivo, que só será falso se ambos forem falsos ou verdadeiros " + xor);

        boolean not = !(a == 3) && (b == 5);
        System.out.println(
                "Operador de NOT, inverterá a lógica ou seja, se for verdadeira inverterá e será falso " + not);
    }
